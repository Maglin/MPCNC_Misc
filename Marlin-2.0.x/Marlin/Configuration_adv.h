...
#define ARC_SUPPORT                 // Disable this feature to save ~3226 bytes
  ...
  #define MM_PER_ARC_SEGMENT    .05 // (mm) Length (or minimum length) of each arc segment
  #define ARC_SEGMENTS_PER_R    1 // Max segment length, MM_PER = Min
  #define MIN_ARC_SEGMENTS       24 // Minimum number of segments in a complete circle
  #define ARC_SEGMENTS_PER_SEC 150 // Use feedrate to choose segment length (with MM_PER_ARC_SEGMENT as the minimum)
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       961        // (mA) RMS current. Multiply by 1.414 for peak current.
